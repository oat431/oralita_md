---
date: 2026-08-17
tags: [fitness, phase-2, daily-workout, wednesday]
---

# Wednesday — Run/Walk + Core

Focus: 30-minute intervals + core. Time: ~40 min.
...
- **Standard:** NO bonus running; **write the actual minutes in the log**
...
- **Warm-up:** 
	- none — core is warm from running
- **Working:** 
	- 2 × 10/side — rest 30 sec
...
- **Warm-up:** 
	- none — core already worked
- **Working:**  rest 30 sec
	- 2 × 10 @ 15 kg
	- 2 × 30 sec
- **Standard:** anti-rotation; keep ribs down
...
- **Warm-up:** 
	- 1 light set — 7.5–10 kg × 10–12 
	- first arm work — the run does not warm the arms
	- rest ~60 sec after
- **Working:** 
	- 2 × 10 @ 15 kg — rest 60 sec
...
- **Warm-up:** 
	- 1 light set — 4–5 kg × 10–12 
	- first shoulder work
	- rest ~60 sec after
- **Working:** 
	- 2 × 12 @ **8 kg** — rest 60 sec
- **Standard:** strict — full ROM, no shrug, no torso lean, 2-sec lowering
