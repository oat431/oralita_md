...
![Continuity - the eye follows smooth lines](https://lawsofux.com/images/continuity.svg)
...
| ❌ | ✅ |
|----|-----|
| Menu items in random positions | Menu items in a horizontal row or vertical column |
| Breadcrumb: Home > Products > ... > Item | Breadcrumb shows smooth path from root to current |

---

## Continuity in Data Display
...
✅ Continuous (line chart / aligned table):
  Jan  Feb  Mar  Apr
   10   20   30   40
```
