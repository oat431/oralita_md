...
![Aesthetic Usability - attractive things work better](https://lawsofux.com/images/aesthetic-usability-effect.svg)
...
```
❌ Ugly but functional:
  A plain HTML form that works perfectly
  → Users assume it's broken or insecure

✅ Clean and functional:
  The same form with proper spacing, typography, consistent colors
  → Users trust it and complete the task
```
