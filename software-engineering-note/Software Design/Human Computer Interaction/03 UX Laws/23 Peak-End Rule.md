...
![Peak-End Rule - peak and end matter most](https://lawsofux.com/images/peak-end-rule.svg)
...
| 😊 Peak | 😊 End |
|--------|-------|
| Free shipping revealed ("You saved $5!") | "Order confirmed! 🎉 Estimated delivery: Friday" |
...
## The "End" Matters Most for Retention

A user's last interaction determines whether they come back:

| ❌ Bad Ending | ✅ Good Ending |
|-------------|---------------|
| Error message after form submission | "Thanks! We'll be in touch within 24 hours." |
| Blank screen after completing a task | Summary, celebration, or "What's next?" suggestion |
| Hard cut-off after payment | Receipt, tracking info, "You might also like..." |
