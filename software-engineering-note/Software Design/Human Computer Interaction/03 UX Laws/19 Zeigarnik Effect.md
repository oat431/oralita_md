...
![Zeigarnik Effect - incomplete tasks stick in memory](https://lawsofux.com/images/zeigarnik-effect.svg)
...
## The Danger: Dark Patterns

The Zeigarnik Effect can manipulate users. Use it ethically:

| ✅ Ethical | ❌ Dark Pattern |
|-----------|----------------|
| Remind users about genuinely incomplete tasks | Fake "incomplete" states to drive engagement |
| Show real progress toward a user's goal | Show progress bars that advance regardless of actual completion |
| Offer to save drafts | Auto-subscribe users to newsletters when they create an account "but haven't finished setting up" |
