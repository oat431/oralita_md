...
Research        Design        Prototype        Test
   ↓               ↓              ↓              ↓
Understand     Create         Build           Validate
the user       solutions      something       with real
                              real            users
   ↓               ↓              ↓              ↓
Interviews,    Sketching,     Wireframes,     Usability
surveys,       wireframes,    clickable       testing,
analytics      user flows     prototypes      feedback
        ← ← ← ← ← ← ← ← ← ← ← ← ← ← ← ← ← ← ← ←
                   ITERATE
```
...
- [ ] Have I watched at least 3 real users try this?
- [ ] Does this solve a problem users actually have?
- [ ] Can users complete the primary task without help?
- [ ] What did users struggle with in testing?
