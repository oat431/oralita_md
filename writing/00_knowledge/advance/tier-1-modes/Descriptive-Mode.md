...
tags: [writing, rhetoric, modes, descriptive]
---
...
```mermaid
flowchart TD
    IMP["General impression"] --> SPEC["Specific details"]
    FG["Foreground"] --> BG["Background"]
    EXT["External appearance"] --> INT["Internal characteristics"]
    MOST["Most important feature"] --> LEAST["Least important feature"]
```
