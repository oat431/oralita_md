...
tags: [writing, rhetoric, modes, narrative]
---
...
```mermaid
flowchart TD
    EXPO["Exposition: setting, participants, initial situation"] --> RISE["Rising action: complication and development"]
    RISE --> CLIMAX["Climax: the decisive moment"]
    CLIMAX --> FALL["Falling action: consequences"]
    FALL --> RESO["Resolution: the outcome"]
    RESO --> REFL["Reflection: the meaning"]
```
