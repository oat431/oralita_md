...
tags: [writing, rhetoric, modes, analytical]
---
...
```mermaid
flowchart TD
    Q["Define the question or problem"] --> S["Establish scope and criteria"]
    S --> E["Present relevant evidence"]
    E --> D["Divide the subject into components"]
    D --> I["Compare, interpret, or evaluate the components"]
    I --> A["Address limitations and alternatives"]
    A --> C["State the conclusion and its implications"]
```
