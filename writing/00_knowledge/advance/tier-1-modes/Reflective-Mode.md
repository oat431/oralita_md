...
tags: [writing, rhetoric, modes, reflective]
---
...
```mermaid
flowchart TD
    DES["Description: what happened?"] --> FEE["Feelings: what did I think and feel?"]
    FEE --> EVAL["Evaluation: what was good or bad?"]
    EVAL --> ANA["Analysis: what sense can I make of it?"]
    ANA --> CON["Conclusion: what else could I have done?"]
    CON --> ACT["Action plan: what will I do next time?"]
    ACT --> DES
```
...
```mermaid
flowchart TD
    CE["Concrete experience: doing or having"] --> RO["Reflective observation: reviewing the experience"]
    RO --> AC["Abstract conceptualization: forming concepts"]
    AC --> AE["Active experimentation: testing in new situations"]
    AE --> CE
```
