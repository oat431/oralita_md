...
tags: [writing, rhetoric, modes, persuasive]
---
...
```mermaid
flowchart TD
    ATT["Attention: open with the hook or the stake"] --> NEED["Need: establish the problem or desire"]
    NEED --> SAT["Satisfaction: present the solution"]
    SAT --> VIS["Visualization: show the result of acting, or not acting"]
    VIS --> ACTION["Action: make the request explicit"]
```
