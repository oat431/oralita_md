...
```mermaid
timeline
    title EPIC: The Musical Timeline
    Troy Saga : Sack of Troy
              : Killing of Astyanax
    Cyclops Saga : Polyphemus blinded
                 : Odysseus reveals his name
                 : Cursed by Poseidon
    Ocean Saga : Wind bag opened
               : Fleet scattered
    Circe Saga : Men turned to pigs
               : Circe becomes ally
    Underworld Saga : Meets the dead
                    : Learns his fate
    --- Act 2 ---
    Thunder Saga : Sacrifice to Scylla
                 : Poseidon destroys fleet
                 : Odysseus strikes back
    Wisdom Saga : Telemachus vs suitors
                : Athena persuades Zeus
    Vengeance Saga : Odysseus returns
                   : Slaughter of suitors
    Ithaca Saga : Reunion with Penelope
                : Wedding bed test
```
