...
```mermaid
timeline
    title Begin Again Timeline
    Before : Dave gets a record deal
           : Gretta follows him to NYC
           : Dave's affair
           : Gretta's heartbreak
    Meeting : Dan is fired from his label
            : Dan hears Gretta sing at a bar
            : They decide to make an album
    Summer : Recording across NYC rooftops and streets
           : Dan reconnects with his family
           : Gretta regains confidence
    Conflict : Dave returns
             : "Lost Stars" version disagreement
             : Gretta leaves the concert
    Resolution : Album released online for $1
               : Dan returns to his label
               : Both have begun again
```
